  ...
  return (
    <>
      {isDirectory ?
        ...
        <a href={`${url}`} target='_blank' className= 'min-w-[110px] max-w-xs bg-white text-green-500 border-2 border-green-500 hover:bg-green-500 hover:text-white active:bg-green-700 active:border-green-700 p-3 rounded'
          onClick={onClick}
          title={children}
        >
